...
•	T-test:
o	Remove NAs, check group counts.
o	If both groups have ≥ 2 observations, run t.test(); otherwise, print a clear message and produce a boxplot of Growth_10yr by site for visual comparison.
Note:
